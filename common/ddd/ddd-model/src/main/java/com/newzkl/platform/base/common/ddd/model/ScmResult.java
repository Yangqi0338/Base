...
@Setter
@Getter
public class ScmResult<T> implements Serializable {
     ...
     * @return
     */
    public static <T> ScmResult<T> success() {
     ...
     * @return R
     */
    public static <T> ScmResult<T> success(T data) {
     ...
     * @return R
     */
    public static <T> ScmResult<T> fail(T data, String msg) {
     ...
     * @return
     */
    public static <T> ScmResult<T> fail() {
     ...
     * @return R
     */
    public static <T> ScmResult<T> fail(String msg) {
     ...
     * @return R
     */
    public static <T> ScmResult<T> fail(ErrorCode errorCode) {
     ...
     * @return R
     */
    public static <T> ScmResult<T> fail(Integer code, String msg) {
        return restResult(code, msg, null, Boolean.FALSE);
    }

    public static <T> ScmResult<T> restResult(Integer code, String message, T data, Boolean success) {
        ScmResult<T> r = new ScmResult<>();
        r.setCode(code);
        r.setData(data);
