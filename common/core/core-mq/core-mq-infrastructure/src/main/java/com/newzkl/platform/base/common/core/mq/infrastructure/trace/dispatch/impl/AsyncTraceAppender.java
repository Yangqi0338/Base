package com.newzkl.platform.base.common.core.mq.infrastructure.trace.dispatch.impl;

import com.newzkl.platform.base.common.core.mq.model.constant.OnsTraceConstants;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.OnsTraceContext;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.common.OnsTraceDataEncoder;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.OnsTraceTransferBean;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.dispatch.AsyncAppender;
...
public class AsyncTraceAppender extends AsyncAppender {
     ...
     * 临时存储batch的数据
     */
    private final List<OnsTraceTransferBean> transDataList;
    ...
    public AsyncTraceAppender(Properties properties) throws MQClientException {
        ...
        if (nameSrv == null) {
            TopAddressing topAddressing = new DefaultTopAddressing(properties.getProperty(OnsTraceConstants.ADDRSRV_URL));
