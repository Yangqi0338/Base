package com.newzkl.platform.base.common.core.mq.infrastructure.trace.common;
...
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.*;
    ...
    public static List<OnsTraceContext> decoderFromTraceDataString(String traceData) {
        ...
        for (String context : contextList) {
            ...
            if (line[0].equals(OnsTraceType.Pub.name())) {
                ...
                OnsTraceBean bean = new OnsTraceBean(MixUtils.getLocalAddress());
                ...
                bean.setMsgType(MessageType.values()[Integer.parseInt(line[11])].toString());
