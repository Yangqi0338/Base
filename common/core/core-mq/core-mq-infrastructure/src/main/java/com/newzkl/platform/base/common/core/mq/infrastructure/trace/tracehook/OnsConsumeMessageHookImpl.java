package com.newzkl.platform.base.common.core.mq.infrastructure.trace.tracehook;


import com.newzkl.platform.base.common.core.mq.infrastructure.trace.OnsTraceBean;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.OnsTraceContext;
import com.newzkl.platform.base.common.core.mq.model.enums.OnsTraceType;
import com.newzkl.platform.base.common.core.mq.infrastructure.trace.dispatch.AsyncDispatcher;
import com.newzkl.platform.base.common.core.mq.infrastructure.utils.MixUtils;
...
public class OnsConsumeMessageHookImpl implements ConsumeMessageHook {
     ...
     */
    private final AsyncDispatcher localDispatcher;
    ...
    public void consumeMessageBefore(ConsumeMessageContext context) {
        ...
        for (MessageExt msg : context.getMsgList()) {
            ...
            OnsTraceBean traceBean = new OnsTraceBean(MixUtils.getLocalAddress());
