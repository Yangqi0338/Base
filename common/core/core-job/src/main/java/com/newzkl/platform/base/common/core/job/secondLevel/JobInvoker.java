...
import com.zhongze.chicken.common.biz.dto.job.AssetJobParam;
import com.zhongze.chicken.common.job.param.SecondLevelJobParam;
import com.zhongze.chicken.common.schedule.BaseJob;
import com.zhongze.chicken.common.schedule.JobContext;
...
public class JobInvoker {
    ...
    public void invokeFill(JobContext.JobMeta meta) {
        /*
         * 按 bizType 选合适的参数类：ASSET 系列用 AssetJobParam（含 fillExecuteLog），否则用 SecondLevelJobParam
         */
    ...
    private SecondLevelJobParam buildFillParam(JobContext.JobMeta meta) {
        /*
         * AssetJobParam 才有 fillExecuteLog 字段；其他任务 fill 概念暂不支持，抛异常保护
         */
