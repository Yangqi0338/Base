package com.newzkl.platform.base.common.core.job.domain;
...
import com.newzkl.platform.base.common.core.job.model.config.XxlJobProperties;
import com.newzkl.platform.base.common.core.job.model.model.XxlJobInfoResp;
import com.newzkl.platform.base.common.core.job.model.model.XxlJobLogResp;
import com.newzkl.platform.base.common.core.job.model.model.XxlJobReturnT;
...
public class XxlJobAdminClient {
     ...
     * @ext 单 jobGroup
     *
     * @param jobGroup      执行器分组 id
     * @param triggerStatus 触发状态过滤, -1 为全部
     * @param start         起始偏移
     * @param length        分页长度
     * @return 任务分页结构
     */
     ...
     * @return 匹配的 xxlJobId, 未找到返回 null
     */
