 ...
 * 运营商域出站端口
 *
 * <p>对等旧 {@code @DubboReference IOperatorFacade} 在商品域的用法: 运营商查供应商商品列表时,
 * 需先按其运营类型 (机构 / 行业 / 区域) 拿到可见供应商 ID 列表, 再据此收敛商品查询范围。
 * 实现落 biz-goods-infrastructure 的 {@code adapt/api}, 由该层依赖 {@code biz-account-facade}
 * 完成跨域调用, 领域层只见本端口。</p>
 *
 * @author KC
 */
