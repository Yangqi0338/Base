...
import com.newzkl.platform.base.biz.auth.infrastructure.dao.AuthMenuDAO;
import com.newzkl.platform.base.biz.auth.infrastructure.dao.AuthRelationsDAO;
import com.newzkl.platform.base.biz.auth.infrastructure.dao.AuthRoleDAO;
import com.newzkl.platform.base.biz.auth.infrastructure.dao.po.AuthFunctionDO;
...
import com.newzkl.platform.base.biz.auth.infrastructure.dao.po.AuthRoleDO;
...
public class AuthRepositoryImpl implements AuthRepository {
    ...
    public Page<LimitRoleVO> rolePage(RolePageQuery query) {
        ...
        Page<AuthRoleDO> limitRoleDOPage = authRoleDAO.selectPage(RepositorySupport.page(query), new BaseLambdaQueryWrapper<AuthRoleDO>()
    ...
    public Page<FunctionVO> functionPage(FunctionPageQuery query) {
        Page<AuthFunctionDO> authFunctionDOPage = authFunctionDAO.selectPage(RepositorySupport.page(query),
