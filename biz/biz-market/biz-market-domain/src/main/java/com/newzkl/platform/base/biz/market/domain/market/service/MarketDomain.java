package com.newzkl.platform.base.biz.market.domain.market.service;
...
public interface MarketDomain {
     ...
     * 保存市场分类
     */
    boolean saveMarketCategory(MarketCategoryVO marketCategory);

    /**
     * 查询市场分类列表
     */
    Page<MarketCategoryVO> queryMarketCategoryPage(MarketCategoryPageQuery query);

    /**
     * 删除分类
     */
    void deleteMarketCategory(Long id);
