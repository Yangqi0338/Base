CREATE TABLE `third_party_order_record` (
  `id` bigint NOT NULL COMMENT '主键ID',
  `platform_type` varchar(255) NULL COMMENT '平台类型',
  `biz_order_no` varchar(255) NULL COMMENT '业务订单号',
  `third_order_no` varchar(255) NULL COMMENT '第三方订单号',
  ...
  PRIMARY KEY (`id`),
  INDEX `auto_idx_third_party_order_record_biz_order_no`(`biz_order_no`) COMMENT '业务订单号',
  INDEX `auto_idx_third_party_order_record_third_order_no`(`third_order_no`) COMMENT '第三方订单号'
