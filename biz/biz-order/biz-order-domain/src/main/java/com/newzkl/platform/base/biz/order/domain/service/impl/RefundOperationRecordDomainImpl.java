 ...
 * 旧 {@code org.springframework.util.Assert} 校验改抛 {@code ScmException},
...
public class RefundOperationRecordDomainImpl implements RefundOperationRecordDomain {
    ...
    public RefundOperationRecord create(RefundOperationRecord record) {
        if (record == null) {
            throw new ScmException(BaseErrorCode.PARAM, "售后操作记录不能为空");
        }
        if (record.getRefundId() == null) {
            throw new ScmException(BaseErrorCode.PARAM, "售后单ID不能为空");
        }
        if (record.getOperatorRoleCode() == null) {
            throw new ScmException(BaseErrorCode.PARAM, "操作方角色编码不能为空");
        }
        if (StrUtil.isBlank(record.getOperatorClient())) {
            throw new ScmException(BaseErrorCode.PARAM, "操作方客户端类型不能为空");
        }
        if (record.getAfterState() == null) {
            throw new ScmException(BaseErrorCode.PARAM, "操作后状态不能为空");
        }
        if (StrUtil.isBlank(record.getOperationContent())) {
            throw new ScmException(BaseErrorCode.PARAM, "操作内容描述不能为空");
        }
        if (record.getId() != null) {
            throw new ScmException(BaseErrorCode.PARAM, "新增时ID必须为空");
        }
    ...
    public RefundOperationRecord update(RefundOperationRecord record) {
        if (record == null || record.getId() == null) {
            throw new ScmException(BaseErrorCode.PARAM, "修改时ID不能为空");
        }
    ...
    public void delete(Long id) {
        if (id == null) {
            throw new ScmException(BaseErrorCode.PARAM, "删除时ID不能为空");
        }
    ...
    public RefundOperationRecord findById(Long id) {
        if (id == null) {
            throw new ScmException(BaseErrorCode.PARAM, "查询时ID不能为空");
        }
    ...
    public List<RefundOperationRecord> listBySpuOrderNo(String spuOrderNo) {
        if (StrUtil.isBlank(spuOrderNo)) {
            throw new ScmException(BaseErrorCode.PARAM, "SPU订单号不能为空");
        }
    ...
    public Page<RefundOperationRecord> pageQuery(RefundOperationRecordPageReq query) {
        if (ObjectUtil.isNull(query)) {
            throw new ScmException(BaseErrorCode.PARAM, "分页参数不能为空");
        }
