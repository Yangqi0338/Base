 ...
 */
@Data
public class SpuOrderVO extends BaseVO {
    ...
    public Integer getPayAmount() {
        return this.storeAmount - this.discountAmount + this.freightAmount;
    }
     ...
     * 由数据反推, 不一定准, 待落库 TODO
     */
    public Integer getChannelDeductAmount() {
        return this.goodsAmount + this.freightAmount + this.serviceAmount;
    }
