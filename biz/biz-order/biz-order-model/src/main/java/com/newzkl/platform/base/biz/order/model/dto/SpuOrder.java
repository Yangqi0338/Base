...
public class SpuOrder implements Serializable {
     ...
     * @param freightAmount
     */
    public void init(OrderCreateCommand orderCreateCommand, MemberOrderCreateCommand memberOrderCreateCommand, Long orderId, Long spuOrderId, List<SkuOrder> orderAmountVO, SkuSaleInfo spuVO, EarningsConfigRpcVO channelVO, Integer freightAmount) {
        this.id = spuOrderId;
        ...
        for (SkuOrder skuOrder : orderAmountVO) {
            //只加属于该SPU订单的SKU
