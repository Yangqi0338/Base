...
public class Refund {
	...
	public void init(RefundCommand refundCommand, SpuOrderAggVO spuOrderAggVO, Map<Long, SkuRefundRes> skuRefundResMap, Integer freightAmount) {
		...
		this.setMerchantId(orderVO.getMerchantId());
