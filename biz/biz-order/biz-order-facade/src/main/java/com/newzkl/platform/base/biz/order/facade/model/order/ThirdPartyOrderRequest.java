 ...
 */
@Data
public class ThirdPartyOrderRequest implements Serializable {
    ...
    /**
     * 创建时间 该请求记录在本系统中的创建时间。
     */
    private LocalDateTime createdAt;
    
    /**
     * 更新时间 该请求记录最后一次状态变更或信息更新的时间。
     */
     ...
     * @return 一个初始化完成的 {@link ThirdPartyOrderRequest} 实例
     */
    public static ThirdPartyOrderRequest init(PlatformTypeEnum platformType, String bizOrderNo, String interfaceName,
