...
import com.newzkl.platform.base.biz.account.model.support.MQ;
...
public class ChannelRepositoryImpl extends RepositorySupport implements ChannelRepository {
    ...
    public Page<ChannelVO> pageList(ChannelQuery query) {
        Page<ChannelDO> channelPage = channelDAO.selectPage(PageBuildUtil.of(query), channelDAO.getLw(query));
