package com.newzkl.platform.base.biz.account.infrastructure.repository;
import com.newzkl.platform.base.biz.account.infrastructure.support.PageBuildUtil;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.newzkl.platform.base.biz.account.infrastructure.support.RepositorySupport;
...
public class SupplierRepositoryImpl extends RepositorySupport implements SupplierRepository {
    ...
    public <T> Page<T> pageObj(SupplierQuery query, Class<T> clazz) {
        return TransferUtils.transferPage(supplierDAO.selectPage(PageBuildUtil.of(query), supplierDAO.getLw(query)), clazz);
    }

    @Override
    public Page<SupplierAccountVO> pageListWithAccount(SupplierQuery query) {
        return supplierDAO.pageListWithAccount(PageBuildUtil.of(query), supplierDAO.getJoinQw(query));
    }
