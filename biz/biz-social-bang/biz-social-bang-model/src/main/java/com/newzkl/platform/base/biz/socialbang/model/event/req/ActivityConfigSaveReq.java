...
import com.newzkl.platform.base.biz.socialbang.model.validator.ActivityIdValid;
...
public class ActivityConfigSaveReq {
    ...
    /**
     * 分红角色
     * @ext 候选枚举 {@link com.newzkl.platform.base.common.ddd.model.enums.RoleEnum}: 1004-运营商 1005-交易师 1006-甄选师; 传参格式 {"roles": [1004, 1005]}
     */
    @NotBlank(groups = {AddCommand.class, UpdateCommand.class})
