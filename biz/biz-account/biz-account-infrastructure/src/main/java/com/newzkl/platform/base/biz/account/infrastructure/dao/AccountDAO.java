...
public interface AccountDAO extends BaseMapper<AccountDO> {
    ...
    default BaseLambdaQueryWrapper<AccountDO> getLw(AccountQuery query) {
        return new BaseLambdaQueryWrapper<AccountDO>()
                ...
                .notEmptyEq(AccountDO::getMainAccountId, query.getMainAccountId())
                ...
                .likeList(AccountDO::getRoleIdList, query.getRoleList())
                .notEmptyLike(AccountDO::getRoleIdList, query.getRole())
                .notEmptyEq(AccountDO::getYqm, query.getYqm())
                .notEmptyEq(AccountDO::getUserAccount, query.getUserAccount())
