...
import com.zkl.scm.finance.model.earnings.req.AccountContributeRpcQuery;
import com.zkl.scm.finance.model.earnings.vo.EarningContributeRpcVO;
import com.zkl.scm.finance.model.purse.req.AccountPurseReq;
import com.zkl.scm.finance.model.purse.res.PurseAmountRes;
...
//                    accountOutVO.setSupplier(supplierAssembler.vo2OutRes((SupplierVO) identityVO));
                ...
                case CHANNEL:
                    ...
                    // 渠道商额外拿店铺信息
                    StoreRPCVO storeRPCVO = storeFacade.storeByChannelId(id);
...
//        List<CountSaleVO> countSaleVO = countSaleDAO.listByQuery(countSaleQuery);
        return null;
    }

    @Override
    public CountSaleVO countSaleByQuery(CountSaleQuery todayCountSaleQuery) {
//        return countSaleDAO.voByQuery(todayCountSaleQuery);
        return null;
    }
...
//        return channelDAO.channelUpId(accountId);
    ...
    public OperatorDomainInfo getOperatorDomainInfoBySub() {
        if (RoleEnum.CompanyRole.DEALER == SecurityUtils.getRole()) {
...
//        List<ChannelVO> channelVO = channelClientDomain.listByQuery(channelQuery);
        ...
        // 批量查询渠道商贡献收益
        List<EarningContributeRpcVO> earningContributeRpcVOS = earningFacade.queryEarningContribute(req);
...
//        List<ChannelPageVO> channelPageVOList = channelPageVOPage.getRecords();
        ...
        List<PurseAmountRes> purseAmountResList = purseFacade.queryPurse(accountPurseReq);
        ...
        List<PurseAmountRes> goodsSeatList = purseFacade.queryPurse(accountPurseReq);
...
//        appAccountVO.setHasStore(CommonEnum.YesOrNo.YES == storePermission);
    ...
    private void doOperatorAppInfo(AccountVO accountVO, AppAccountVO appAccountVO) {
        ...
        accountParentQuery.setRoleIdList(ScmUtil.findClientRoleIdList(CommonEnum.Client.OPERATOR));
