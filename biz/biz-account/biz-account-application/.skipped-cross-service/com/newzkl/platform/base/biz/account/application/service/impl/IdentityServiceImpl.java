...
import com.zkl.scm.finance.model.account.res.ChannelServiceAmountRes;
...
import com.zkl.scm.finance.rpc.facade.pay.IOrderPayFacade;
...
public class IdentityServiceImpl implements IdentityService {
    ...
    @DubboReference
    private IOrderPayFacade orderPayFacade;
    @DubboReference
    private IStoreFacade storeFacade;
    private final OperatorRepository operatorRepository;
    @DubboReference
    private IAccountPurseConfigFacade purseConfigFacade;
    @DubboReference
...
//        dealerDomain.dealerEdit(Collections.singletonList(new EditColumnDTO("invite_channel_number", -1)), channel.getUpDealerId());
//        dealerDomain.dealerEdit(Collections.singletonList(new EditColumnDTO("invite_channel_number", 1)), dealerId);
...
//            storeRegisterReq.setStoreType(FinanceProperties.storeFixCategory);
        ...
        if (operatorEditReq.getLeverageRatio() != null) {
            purseConfigFacade.saveOperatorLeverConfig(id, operatorEditReq.getLeverageRatio());
        }
    }

    @Override
    public ServiceFeeConfigVO queryServiceFeeConfig(Long channelId) {
//        ChannelServiceAmountRes channelConfigVO = purseConfigFacade.queryChannelNowServiceFee(channelId);
        ChannelServiceAmountRes channelConfigVO = null;
