 ...
 */
@Component
public class OperatorAccountPolicy extends AbsAccountPolicy {

    @Override
    public CommonEnum.Client support() {
        return CommonEnum.Client.OPERATOR;
    }
     ...
     * 新签名要求返回 {@code AccountRegisterRes}, 为保持与本类 {@link OperatorAccountPolicy#customRegister} 一致的
